...
def run_experiments(log_data: LogData, evaluation_traces: pd.DataFrame, maxlen, encoder: Encodings, char_indices,
                    ...
                    method_fitness: str=None, resource: bool=False, weight: list=[0.0], bk_end:bool=False):
    ...
    def apply_trace(trace, prefix_size, log_data, predict_size, bk_file, target_indices_char,
                    target_indices_char_group,bk_model, method_fitness, resource, weight,bk_end):
            ...
            if check_prefix == None:
                            ...
                            if bk_end:
                                ...
                                if resource:
                                    BK_res = compliance_checking(log_data, child_node.cropped_line[-1],child_node.cropped_line_group[-1], \
                                                                 bk_model, prefix_trace,resource) if shared.BK_type == BK_type.Declare else 0
                                else:
                                    ...
                                    if shared.BK_type == BK_type.Procedural:
                ...
                if resource:
                    ...
                    if dls_combined < 0:
                        dls_combined = 0
                    output.append(dls_combined)
                output.append(check_prefix[13]) if resource else check_prefix[7] # weight
                print(output)
