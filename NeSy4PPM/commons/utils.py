...
def extract_last_model_checkpoint(log_name: str, models_folder:str, fold: int, model_type: str,ckeckpoint_folder=shared.output_folder) -> Path:
    model_filepath = ckeckpoint_folder / models_folder / str(fold) / 'models' / model_type / log_name
...
def load_bk(BK_file:Path):
    ...
    if BK_file.endswith('bpmn'):
        ...
        shared.BK_type = BK_type.Declare
        ...
        shared.BK_type = BK_type.ProbDeclare
